...
namespace Fundation.Core
{
    public class WpfIconStatus
    {
        ...
        /// 主窗口初始状态
        /// </summary>
        private WindowState _LastFrmState = WindowState.Maximized;

        /// <summary>
        /// 构造函数
        /// </summary>
        /// <param name="resourceName">ico（嵌入类）资源名</param>
        public WpfIconStatus(string resourceName)
        {
            #region
        ...
        public WpfIconStatus(string resourceName, string icoText)
            :this(resourceName)
        {
            #region
        ...
        public void BindToWindow(Window mainFrm)
        {
            #region
